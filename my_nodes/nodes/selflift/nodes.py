"""MiniMax H3 SelfLift progressive-resolution sampler.
...
MiniMax H3 uses nested AV latents; the audio stream has no spatial dimensions
and continues through the reused Euler boundary step. This is an experimental
extension beyond the paper's image-model evaluation.
"""
...
class SelfLiftH3Sampler:
    NODE_ID = "MySelfLiftH3Sampler"
    DISPLAY_NAME = "My SelfLift Progressive Sampler (MiniMax H3)"
