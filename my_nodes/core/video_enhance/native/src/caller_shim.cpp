...
// commit a01887d489b8053af07673dd277079f412dc9022, file native/src/caller_shim.cpp.
// See ../THIRD_PARTY_NOTICES.md. This file is unmodified apart from this note:
// it is built next to the bridge DLL, and the bridge loads it from there
// (never from the user's NVIDIA runtime directory) when neural rendering is
// enabled.
